...
$id = 1; // assuming this is the Main Character package
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (mysqli_query($conn, $update)) {
    header("Location: edit_packages_maincharacter.php?success=1");
    exit();
  } else {
...
<head>
  ...
  <title>Edit MainCharacter Package | Montra Studio</title>
...
<body>
  <div class="d-flex">
    ...
    <main class="main-content p-5 flex-grow-1 bg-light">
      <div class="container">
        <h2 class="fw-semibold mb-4">Edit “Main Character” Package</h2>
                ...
                foreach ($imgs as $img):
                  ...
                  if ($img): ?>
                    <div class="gallery-img">
                      ...
                      <a href="delete_image.php?package_id=<?= $package['id'] ?>&filename=<?= urlencode($img) ?>" 
